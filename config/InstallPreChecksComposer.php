...
class InstallPreChecksComposer
{
    ...
    {
        require BASE_PATH. '/../../../../public/legacy/php_version.php';
    ...
    function checkMainPage(string $baseUrl = ''): array
    {
        ...
        $ch = curl_init();
        $timeout = 5;
        $logFile = BASE_PATH. '/../../../../logs/install.log';
    ...
    public function getLanguageStrings(): array
    {
        ...
        $enUsLangPack = BASE_PATH. '/../../../../public/legacy/install/language/'. $lang . '.lang.php';
        ...
        $langPack = BASE_PATH. '/../../../../public/legacy/install/language/' . $lang . '.lang.php';
    ...
    public function getConfigValues(): array
    {
        ...
        $configFile = BASE_PATH. '/../../../../public/legacy/config.php';
    ...
    public function getConfigOverrideValues(): array
    {
        ...
        $configOverrideFile = BASE_PATH. '/../../../../public/legacy/config_override.php';
    ...
    public function checkFolderIsWritable(string $folderName, array &$labels, string $parentDir = ''): array {
        ...
        if (!empty($parentDir)){
            $folder = BASE_PATH. '/../../../../' . $parentDir . '/' . $folderName;
        }
